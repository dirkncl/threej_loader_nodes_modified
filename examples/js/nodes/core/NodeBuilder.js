 ...
 */
/*
dependency :  (path+'core/NodeUniform.js');
dependency :  (path+'core/NodeUniform.js');
dependency :  (path+'core/NodeUtils.js');
dependency :  (path+'core/NodeLib.js');
dependency :  (path+'core/FunctionNode.js');
dependency :  (path+'core/ConstNode.js');
dependency :  (path+'core/StructNode.js');

dependency :  (path+'inputs/Vector2Node.js');
dependency :  (path+'inputs/Vector3Node.js');
dependency :  (path+'inputs/Vector4Node.js');
dependency :  (path+'inputs/TextureNode.js');
dependency :  (path+'inputs/CubeTextureNode.js');
*/
