...
dependency :  (path+'effects/LuminanceNode.js');
*/
var buff = fs.readFileSync(path+'effects/ColorAdjustmentNode.gpu');
var Shaders = bufferGPUParse(buff);
var HUE = Shaders['hue'];
var SATURATION = Shaders['saturation'];
var VIBRANCE = Shaders['vibrance'];
...
ColorAdjustmentNode.Nodes = ( function () {
	...
	var saturation = new FunctionNode( SATURATION/*[
	...
	var vibrance = new FunctionNode( VIBRANCE/*[
