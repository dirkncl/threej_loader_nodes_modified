...
function enableWebGLCanvas( canvas, options )
{
  ...
  var Canvas2DtoWebGLBuffer = fs.readFileSync("../src/Canvas2DtoWebGL.glsl")
  var Shaders = bufferGPUParse(Canvas2DtoWebGLBuffer)
  
  var Vertex_Shader = Shaders["vertex_shader"];
  var Flat_Primitive_Shader = Shaders["flat_primitive_shader"];
  var Textured_Transform_Shader = Shaders["textured_transform_shader"];
  var Textured_Primitive_Shader = Shaders["textured_primitive_shader"];
  var Gradient_Primitive_Shader = Shaders["gradient_primitive_shader"];
  var Create_Image_Shader = Shaders["createImageShader"];
  var Point_Text_Vertex_Shader = Shaders["POINT_TEXT_VERTEX_SHADER"];
  var Point_Text_Fragment_Shader = Shaders["POINT_TEXT_FRAGMENT_SHADER"];
  var Triangle_Text_Vertex_Shader = Shaders["TRIANGLE_TEXT_VERTEX_SHADER"];
  var Triangle_Text_Fragment_Shader = Shaders["TRIANGLE_TEXT_FRAGMENT_SHADER"];
	...
	var	flat_primitive_shader = new GL.Shader(vertex_shader, Flat_Primitive_Shader, extra_macros );

	var	textured_transform_shader = new GL.Shader(GL.Shader.QUAD_VERTEX_SHADER,Textured_Transform_Shader, extra_macros );

	var	textured_primitive_shader = new GL.Shader(vertex_shader, Textured_Primitive_Shader, extra_macros );

	var	gradient_primitive_shader = new GL.Shader(vertex_shader, Gradient_Primitive_Shader, extra_macros );

	ctx.createImageShader = function(code) {
		return new GL.Shader( GL.Shader.QUAD_VERTEX_SHADER, parts(Create_Image_Shader, code), extra_macros );
	}
	...
	//extra
	var POINT_TEXT_VERTEX_SHADER = Point_Text_Vertex_Shader;

	var POINT_TEXT_FRAGMENT_SHADER = Point_Text_Fragment_Shader;
	...
	var TRIANGLE_TEXT_VERTEX_SHADER = Triangle_Text_Vertex_Shader;

	var TRIANGLE_TEXT_FRAGMENT_SHADER = Triangle_Text_Fragment_Shader;
	*/
